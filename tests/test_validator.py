...
class TestValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher_timestamp = patch('config.TIMESTAMP_PATTERN', re.compile(r'^\d{8}$'))
    ...
    def test_start_date_after_end_date(self):
        ...
        self.assertIn("start_date must be earlier than or equal to end_date", str(cm.exception))
